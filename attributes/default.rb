case node['platform']
when 'ubuntu'
  default['chef11server']['download'] = "https://packages.chef.io/stable/ubuntu/12.04/chef-server_11.1.6-1_amd64.deb"
  default['chef11server']['filename'] = "chef-server_11.1.6-1_amd64.deb"
when 'centos'
  default['chef11server']['download'] = "https://packages.chef.io/stable/el/6/chef-server-11.1.6-1.el6.x86_64.rpm"
